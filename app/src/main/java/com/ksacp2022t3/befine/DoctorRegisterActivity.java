...
public class DoctorRegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_location.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(DoctorRegisterActivity.this,SelectLocationActivity.class);
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    makeText(DoctorRegisterActivity.this,"You should select pharmacy location" , LENGTH_LONG).show();
                    return;
                }
                ...
                firebaseAuth.createUserWithEmailAndPassword(str_txt_email,str_txt_password)
                        .addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                            ...
                            public void onSuccess(AuthResult authResult) {
                                ...
                                account.setSpeciality(str_txt_speciality);
                                ...
                                firestore.collection("accounts").document(user.getUid()).set(account)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void unused) {
                                                SharedPreferences sharedPreferences=DoctorRegisterActivity.this.getSharedPreferences("befine",MODE_PRIVATE);
                                                ...
                                                Intent intent = new Intent(DoctorRegisterActivity.this,DoctorHomeActivity.
                                                        class);
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                makeText(DoctorRegisterActivity.this,"Error :"+e.getMessage() , LENGTH_LONG).show();
                                                progressDialog.dismiss();
                                            }
                                        });
                            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==110)
            ...
            {
                makeText(DoctorRegisterActivity.this,"Location set successfully", LENGTH_LONG).show();
